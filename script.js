document.getElementById("weatherSubmit").addEventListener("click", function(event) {
  ...
  const url = "http://api.openweathermap.org/data/2.5/weather?q=" + value + ",US&units=imperial" + "&APPID=1f188247703d130ad3554b0f0c4e3415";
  fetch(url)
...
document.getElementById("weatherSubmit").addEventListener("click", function(event) {
  ...
  const url2 = "http://api.openweathermap.org/data/2.5/forecast?q=" + value + ", US&units=imperial" + "&APPID=1f188247703d130ad3554b0f0c4e3415";
  fetch(url2)
    .then(function(response) {
      return response.json();
    }).then(function(json) {
